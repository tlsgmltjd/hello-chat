...
import com.example.hellochat.domain.chat.dto.request.ChatMessageDetailDTO;
import com.example.hellochat.domain.chat.dto.request.ChatMessageSaveDTO;
...
import com.example.hellochat.domain.chat.repository.ChatRoomRepository;
...
public class ChatController {
    ...
    public void enter(ChatMessageDetailDTO message) {
        ...
        List<ChatMessageDetailDTO> chatList = cs
        if(chatList != null){
        ...
        ChatRoom chatRoomEntity= crr.findByRoomId(message.getRoomId());
        ChatMessageSaveDTO chatMessageSaveDTO = new ChatMessageSaveDTO(message.getRoomId(),message.getWriter(), message.getMessage());
        cr.save(ChatMessage.toChatEntity(chatMessageSaveDTO,chatRoomEntity));
    }
